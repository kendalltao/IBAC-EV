 ...
 */
class CencorRouteStrategyBase : public Strategy
{
public:
  void
...
protected:
  CencorRouteStrategyBase(Forwarder& forwarder);
  
};

class CencorRouteStrategy : public CencorRouteStrategyBase
{
public:
  explicit
  CencorRouteStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
