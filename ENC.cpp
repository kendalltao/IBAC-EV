...
int main(int argc, char **argv) {
  ...
  ndn::StrategyChoiceHelper::Install(authorizedcon[i], "/xyz.com", "/localhost/nfd/strategy/best-route");
  ndn::StrategyChoiceHelper::Install(unauthorizedcon[i], "/xyz.com", "/localhost/nfd/strategy/best-route");
}
  ndnHelper.Install(producer);
  ndn::StrategyChoiceHelper::Install(producer, "/xyz.com", "/localhost/nfd/strategy/best-route");
  ...
  ndn::StrategyChoiceHelper::Install(edgerouter[i], "/xyz.com", "/localhost/nfd/strategy/best-route");
  }
  ...
  consumerHelper.SetAttribute("Frequency", StringValue("10"));       //10 interests per seconds
  consumerHelper.SetPrefix("/xyz.com");
...
// }
  ...
  // ndn::AppDelayTracer::InstallAll("ENC_delay.txt");
  ndn::CsTracer::InstallAll("rate-ENC-5.txt", Seconds(5));
  // ndn::L3RateTracer::InstallAll("taoyu3.txt",Seconds (1));
  // L2RateTracer::InstallAll("taoyu2.txt",Seconds (1));
