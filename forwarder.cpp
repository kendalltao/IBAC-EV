...
Forwarder::onIncomingInterest(Face& inFace, const Interest& interest)
{
  ...
  if (node == 15){
      ...
      t1 = (time.tv_sec*1000000 + time.tv_usec);
      // std::cout <<"node: " << node << "; time: " << t1 << std::endl;
  }
  ...
  if (!pitEntry->hasInRecords()) {
    if (m_csFromNdnSim == nullptr) {
      ...
      if (node == 15){
        ...
        std::cout << "1 time: " << (t2-t1) << "us" << std::endl;
  }
      }
      else {
        ...
        t2 = (time.tv_sec*1000000 + time.tv_usec);
        // std::cout << "node: " << node << std::endl;
        std::cout << "2 time: " << (t2-t1) << "us" << std::endl;
  ...
  if (node == 15){
        ...
        int m = (t2-t1);
        // if (m > 300)
        std::cout << "444444 time: " << m << "us" << std::endl;
      }
  else {
    this->onContentStoreMiss(inFace, pitEntry, interest);
  }
                              ...
                              const Interest& interest)
{
  ...
  //     t2 = (time.tv_sec*1000000 + time.tv_usec);
  //     // std::cout << "node: " << node << std::endl;
  //     // std::cout << "ttttttttttttt time: " << (t2-t1) << "us" << std::endl;
  // }
  ...
  //     t2 = (time.tv_sec*1000000 + time.tv_usec);
  //     // std::cout << "node: " << node << std::endl;
  //     std::cout << "onContentStoreMiss time: " << (t2-t1) << "us" << std::endl;
  // }
}
                             ...
                             const Interest& interest, const Data& data)
{
  ...
  //     // t2 = (time.tv_sec*1000000 + time.tv_usec);
  //     // std::cout << "node: " << node << std::endl;
  //     std::cout << "onContentStoreHit time: " << (t2-t1) << "us" << std::endl;
  // }
}
...
//       t2 = (time.tv_sec*1000000 + time.tv_usec);
//       // std::cout << "node: " << node << std::endl;
//       std::cout << "onOutgoingInterest time: " << (t2-t1) << "us" << std::endl;
//   }
}
...
Forwarder::onIncomingData(Face& inFace, const Data& data)
{
  ...
  if (node == 15){
      ...
      t2 = (time.tv_sec*1000000 + time.tv_usec);
      // std::cout << "node: " << node << std::endl;
      std::cout << "3 time: " << (t2-t1) << "us" << std::endl;
  }
}
...
//       t2 = (time.tv_sec*1000000 + time.tv_usec);
//       // std::cout << "node: " << node << std::endl;
//       std::cout << "onOutgoingData time: " << (t2-t1) << "us" << std::endl;
//   }
}
...
Forwarder::onIncomingNack(Face& inFace, const lp::Nack& nack)
{
  ...
  //     t2 = (time.tv_sec*1000000 + time.tv_usec);
  //     // std::cout << "node: " << node << std::endl;
  //     std::cout << "onIncomingNack time: " << (t2-t1) << "us" << std::endl;
  // }
                          ...
                          const lp::NackHeader& nack)
{
  ...
  //     t2 = (time.tv_sec*1000000 + time.tv_usec);
  //     // std::cout << "node: " << node << std::endl;
  //     std::cout << "onOutgoingNack time: " << (t2-t1) << "us" << std::endl;
  // }
}
